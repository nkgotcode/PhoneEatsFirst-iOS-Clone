...
public extension StorageReference {
  func putData(_ uploadData: Data,
               metadata: StorageMetadata? = nil) -> AnyPublisher<StorageMetadata, Error>
  {
  ...
  func downloadURL() -> AnyPublisher<URL, Error> {
  ...
  func write(toFile url: URL) -> AnyPublisher<URL, Error> {
    var task: StorageDownloadTask?
  ...
  func getMetadata() -> AnyPublisher<StorageMetadata, Error> {
  ...
  func updateMetadata(_ metadata: StorageMetadata) -> AnyPublisher<StorageMetadata, Error> {
    Future<StorageMetadata, Error> { [weak self] promise in
