...
class VectorSplashView: UIView {
  private var shapeLayer: CAShapeLayer!
  private var animation: CAAnimation!
  private var backgroundViewColor: UIColor!
  private var completion: (() -> Void)?
  
  init(bezierPath: UIBezierPath, logoColor: UIColor = .white, backgroundColor: UIColor = .black) {
#if !os(macOS)
    ...
    bgColor.values = [logoColor.cgColor, UIColor.clear.cgColor]
  ...
  private func createShapeLayer(with bezier: UIBezierPath) -> CAShapeLayer {
...
extension SplashView {
  static func cdslBezierPath() -> UIBezierPath {
